...
http.createServer(function(req, res) {
	...
	if (uri == '/img.jpg') {
		...
		var updateLoop = setInterval(function() {
			...
			// get buffer of image
			var imgB = fs.readFileSync('img.jpg');
		...
		res.end('<html><head><script>setInterval(function() {document.getElementById("rawr").src = "/img.jpg?"+Date.now();},1000);</script><title>FLIRCAM</title></head><body><img id="rawr" src="/img.jpg" width="640" height="480" /><body></html>');
